...
/* ============================== CONFIG ============================== */
// 이 파생 사이트는 고정 코드(0303/0217) 대신 닉네임+비밀번호 회원가입으로 로그인합니다.
// 닉네임 자체가 로그인 식별자(userCode)로 쓰이기 때문에, 기존 코드베이스에서
// userCode/user.code를 참조하던 부분들을 그대로 재사용할 수 있습니다.
  ...
  return(
    <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
      <div style={{textAlign:"center",maxWidth:340,width:"100%"}}>
        ...
        <div className="coc-display" style={{fontSize:20,color:"var(--accent-deep)",marginBottom:5}}>NEON 1989</div>
        ...
        {!activeRoom&&(
          <div style={{maxWidth:680,margin:"0 auto 22px",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:10}}>
            <div style={{display:"flex",alignItems:"center",gap:8}}>
              ...
              <span className="coc-display" style={{fontSize:13,color:"var(--accent-deep)"}}>NEON 1989</span>
